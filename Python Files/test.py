...
# recovery_gauge = dashboard.GaugeChart(row_index=0, column_index=2)
...
# cost_incident_ratio_gauge = dashboard.GaugeChart(row_index=1, column_index=2)
...
# cost_incident_ratio_gauge.set_unit_label('USD/Incident')
